...
* 盒模型有两种：box-sizing: content-box 标准盒模型，border-box怪异盒模型

* 标准盒模型：content包含属性 width、height，不包括 border，padding
* 怪异盒模型：content包含width、height、padding、border宽度
* ie8+ 使用box-sizing来控制盒模型，默认为 content-box 标准盒模型
